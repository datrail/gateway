...
self_test() (
  ...
  check_case wiremock-compose e2e/compose.yml '/home/wiremock' 0 '' || return
  check_case wiremock-other tests/fixture.py '/home/wiremock' 1 'tests/fixture.py:1:/home/wiremock' || return
  check_case wiremock-prefix e2e/compose.yml '/home/wiremockevil/project' 1 'e2e/compose.yml:1:/home/wiremockevil' || return
